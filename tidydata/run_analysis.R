...
#To load and view the uploaded tidy data set, "tidydata.txt", 
#please do the following in R/RStudio.
...
#required packages for string processing and reshaping datasets
        require(stringr)
        require(reshape2)
#All the data files from the test and train folders, along with the activity_labels
#text file are read into R
...
# the combined rows of 10299 each of the variables, the subjects and actitvites, 
